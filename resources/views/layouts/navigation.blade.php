<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 hidden lg:flex flex-col lg:w-48 xl:w-96 fixed left-0 top-0 bottom-0">
    <div class=" h-24 flex justify-center items-center ">
        ...
        <img src="{{ asset('Logo_Rectangle.png') }}" alt="Logo" class="h-24">
    </div>
    <div class ="flex w-full h-screen rounded-r-xl text-black">
        <ul class="flex flex-col gap-5 pt-5 h-screen bg-[#fb9333] rounded-r-xl">
            <a href=""><li class="pl-8 text-[24px]">Esmaabi</li></a>
            <a href=""><li class="pl-8 text-[24px]">Ennetus</li></a>
