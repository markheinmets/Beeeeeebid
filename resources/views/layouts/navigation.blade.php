<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 hidden lg:flex flex-col lg:w-48 xl:w-96 fixed left-0 top-0 bottom-0">
    ...
    <div clss ="flex w-full h-screen rounded-r-xl text-black">
        <ul class="flex flex-col gap-5 pt-5 h-screen bg-[#fb9333] rounded-r-xl">
            <a href="{{ route('home') }}#esmaabi"><li class="pl-8 text-[24px]">Esmaabi</li></a>
            <a href="{{ route('home') }}#ennetavad-tegevused"><li class="pl-8 text-[24px]">Ennetus</li></a>
            <a href="{{ route('home') }}#vaimse-tervise-esmaabi"><li class="pl-8 text-[24px]">Vaimse tervise esmaabi</li></a>
            <a href="{{ route('home') }}#test"><li class="pl-8 text-[24px]"> Juhendid</li></a>
        </ul>
